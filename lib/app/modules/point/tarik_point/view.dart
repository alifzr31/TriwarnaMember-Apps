              ...
              child: BaseRefresh(
                ...
                child: GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    final prize = controller.prize[index];
                    final point = int.parse(prize.point.toString());
                    final userPoint = int.parse(
                        userController.user.value!.loyaltyPoint.toString());
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    FadeAnimation(
                                      ...
                                      child: Align(
                                        alignment: Alignment.centerLeft,
                                        child: Text(prize.prizeDesc.toString()),
                                      ),
                                    ),
                                  ],
                                ),
